# Manual disposable installation

Run these commands from the repository root. For the shorter installer path,
see the [disposable quickstart](../quickstart.md).
...
**Semantic search requires an OpenAI API key.** This disposable script
