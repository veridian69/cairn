...
`CAIRN_IMAGE=cairn:v0.7.8` in `../images.lock` is a local build tag, not a
...
make image IMAGE=cairn:v0.7.8
docker image inspect --format '{{.Id}}' cairn:v0.7.8
```
