...
`CAIRN_IMAGE=cairn:v0.7.0-rc.4` in `../images.lock` is a local build tag, not a
...
make image IMAGE=cairn:v0.7.0-rc.4
docker image inspect --format '{{.Id}}' cairn:v0.7.0-rc.4
```
...
preflight_image='cairn:v0.7.0-rc.4'
