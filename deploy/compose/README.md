...
`CAIRN_IMAGE=cairn:v0.7.0-rc.5` in `../images.lock` is a local build tag, not a
...
make image IMAGE=cairn:v0.7.0-rc.5
docker image inspect --format '{{.Id}}' cairn:v0.7.0-rc.5
```
...
preflight_image='cairn:v0.7.0-rc.5'
